...
|---:|---:|
| mob на 5+ уровней выше | 1.50 cap |
| +4 | 1.40 |
| +3 | 1.30 |
| +2 | 1.20 |
| +1 | 1.10 |
...
Таким образом level 1 персонаж получает умеренный бонус за более сильного противника, level 4 получает с level 1 Молодого волка только 4 XP, а начиная с разрыва в 5 уровней слабый mob XP не даёт вообще.
