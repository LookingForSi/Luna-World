...
Статус: **разрешён владельцем к реализации 2026-09-19**.
...
Владелец проекта **явно разрешил начать implementation 2026-09-19 до финального visual/runtime review PR #4**. Координаты считаются рабочим greybox-contract и могут быть скорректированы после Studio playtest без переименования stable IDs.
