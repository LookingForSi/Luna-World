...
Текущий зафиксированный checkpoint проекта: `0.1.0-beta.1`. Следующая стадия после прохождения beta release-gate — `0.1.0-rc.1`, затем стабильная версия vertical slice — `0.1.0`.
