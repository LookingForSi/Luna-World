...
### dev0.2 — Level-up recovery

- При реальном повышении уровня персонаж полностью восстанавливает CP, HP и основной ресурс класса уже с учётом новых максимумов уровня и экипировки.
- Обычное получение XP без level-up ничего не восстанавливает.
- Studio-кнопка повышения уровня повторяет это поведение только при движении уровня вверх; cooldowns, target и активные combat effects при refill не сбрасываются.
