...
for token in ("Enum.KeyCode.I", "Enum.KeyCode.ButtonSelect", "BindActionAtPriority", "ContextActionPriority.High", "UserInputService.InputBegan", "GetFocusedTextBox", "requestSnapshot"):
